...
:doctype: book
:imagesdir: images
:pdf-theme: pypreptheme.yml
:source-highlighter: rouge
:rouge-style: github
:source-language: python
:icons: font
:homepage: https://zipcodewilmington.com/pyprep
:pdf-page-size:  [7.0in, 9.0in]
:toc:
...
Copyright (C) 2020 - 2027 by Zip Code Wilmington. All Rights Reserved.

Published in the U.S.A.

May 2021: First Edition
October 2026: Second Edition
...
I especially wish to thank Mikaila Akeredolu: without his brilliant javascript prep session slides as the starting point for the javascript version of this book, I would never have thought a small book on the basic fundamentals of programming would be possible or even useful.
...
This book's aim is to provide you with the most basic of fundamentals regarding Python, one of the most popular programming languages available.
It springs from the Javascript preparation sessions we often give prospective Zip Code applicants on how to do well on the Zip Code application coding assessment.
To someone who has spent some time with programming languages, this might be just a breezy intro to Python.
...
You may be aware that Zip Code has a _data engineering_ course that teaches Python, and while the first book was JavaScript, this one is, well...
...
Python also has the advantage that one can learn to use it without a lot of setup on a computer. In fact, almost every computer you have access to can run Python. You can run almost every code snippet in the book and _see_ what the code does.

==== Focuses on coding

Finally, because in this book all we aim to teach you is "programming in the small", Python is great for that. Many of the examples here are significantly less that 20 lines in length. We want you to get better at looking at small blocks of code to see how they work. These smaller examples and concepts are a core building block as you become proficient in coding.

==== You'll learn it eventually

The truth is, in today's coding world, all of us eventually learn to do things with Python. (I've said this about JavaScript too.)
And as of 2023, it's perhaps the world's most popular programming language.
So, start early, get comfortable with it, and then go on and study other computer languages like Java or JavaScript.
Python will always be there, waiting patiently for you to return.
And hey, if you've already learned Java, you might find this book helpful - bridging languages is a great skill for a developer to have.
...
You're here, reading this, because you're thinking (or maybe you know) that you want to become a programmer. It's pretty straight-forward.
...
Watching hours of YouTube videos _will not_ make you a programmer.

Reading dozens of blog posts, Medium articles, and books _will not_ make you a programmer.

Following along with endless step-by-step tutorials _will not_ make you a programmer.
...
Many have heard my often-repeated admonition: *If you coded today, you're a programmer. If not, you're not a programmer.* It really is as simple as that.
...
Working on code every day makes you a programmer. And coding everyday will help with your ability to eventually score high enough on the Zip Code admissions assessment that you get asked to group and potentially final interviews. And then, well, then you get to learn Java or Python and work yourself to exhaustion doing so. Lots and lots more hours.
...
include::functionparams.adoc[]

include::typehints.adoc[]

include::builtins.adoc[]

include::lambdas.adoc[]

include::builtinsadvanced.adoc[]

include::listcomprehension.adoc[]

include::dictcomprehension.adoc[]

include::setcomprehension.adoc[]

include::modules.adoc[]

include::runvsimport.adoc[]

include::objectsmethods.adoc[]

include::dundermethods.adoc[]
...
_Here are a series of other resources to go on from this point._
...
It has all sorts of tools to help you create Python programs.
