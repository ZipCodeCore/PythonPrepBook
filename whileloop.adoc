...
The primary purpose of loops is to avoid having lots of repetition in code.
...
----
while (player[1].is_alive() == True):
    player[1].take_turn()
    game.update_status(player[1])
----
