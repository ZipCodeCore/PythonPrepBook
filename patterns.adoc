...
Any experienced programmer would say that the ability to see patterns in code, remember them, and learn from them when creating code is another kind of 'superpower'.
...
Lists are often something that confuses beginning programmers. Let's look at some code patterns with lists that you see how lists and loops can work together to get a lot of work pretty easily.
