...
maximum_room_occupancy = tables * people_per_table
# up to this point we just stepped line by line

if (brides_desired_party_size > maximum_room_occupancy):
    can_handle_this_reception = False
else:
    can_handle_this_reception = True
----
